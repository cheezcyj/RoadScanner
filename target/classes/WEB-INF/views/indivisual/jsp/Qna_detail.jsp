...
<body>
    ...
    <div class="container my-4">
        ...
        <form>
            ...
            <div class="mb-3">
                <input class="form-control" type="text" value="${qna.qTitle}" aria-label="Disabled input example" disabled readonly>
            </div>

            <div class="row mb-3">
                <div class="col">작성자: ${qna.rId}</div>
                <div class="col-md-auto">작성일: ${qna.qRegDate}</div>
                <div class="col-md-auto">조회수: ${qna.qReadCnt}</div>
            </div>

            <div class="mb-3">
                <textarea class="form-control" aria-label="Disabled input example" disabled readonly rows="5">${qna.qContents}</textarea>
            </div>
            ...
            <div class="text-center mb-3">
                <button type="button" class="btn btn-primary me-2" onclick="location.href='${CP}/qna'">목록</button>
                <button type="button" class="btn btn-primary me-2" onclick="location.href='${CP}/board/write'">게시글쓰기</button>
